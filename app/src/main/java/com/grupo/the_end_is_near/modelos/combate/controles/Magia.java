...
public class Magia extends Modelo {
    public Magia(Context context) {
        super(context, GameView.pantallaAncho*0.22 , GameView.pantallaAlto*0.925 ,
                GameView.pantallaAlto, GameView.pantallaAncho);

        altura = 40;
        ancho = 40;

        imagen = CargadorGraficos.cargarDrawable(context, R.drawable.boton_magia);
    }
